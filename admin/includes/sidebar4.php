 ...
 <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle  active" data-bs-toggle="dropdown"><i class="fa fa-check-square me-2"></i>Enquiry</a>
                        <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="search-pass.php" class="nav-item nav-link"><i class="fa fa-search me-2"></i>Search</a>

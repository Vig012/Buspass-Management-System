...
<head>
    <meta charset="utf-8">
    <title>Bus Pass Management System | Pass report detail</title>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h3 class="mb-4">Between Date Reports of Pass</h3>
...
?>
<h5 align="center" style="color:red">Pass Report from <?php echo $fdate?> to <?php echo $tdate?></h5>

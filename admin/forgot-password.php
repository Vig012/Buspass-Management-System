                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form role="form" method="post" name="login">
                                <p style="text-align: center;"><h3 class="text-primary"><i class="fa fa-bus me-2"></i>Bus Pass System</h3></p>
                            </a>
                            <h3>Reset Your Password</h3>
                        </div>
                        <fieldset>
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="floatingInput" required="true" name="email">
                            <label for="floatingInput">Email</label>
                        </div>
                        <div class="form-floating mb-3">
                        <input class="form-control" placeholder="Mobile Number" name="mobile" maxlength="10" pattern="[0-9]+" required="true" type="text">
                            <label for="floatingInput">Mob No</label>
                        </div>
